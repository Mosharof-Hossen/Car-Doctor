        ...
        <div className="p-10 dark:text-white">
            <div>
                <div className="space-y-3">
                    ...
                    <ul className="list-inside">
                        <li className="list-disc"><span className="font-semibold">General Information:</span>  info@cardoctor.com</li>
                        <li className="list-disc"><span className="font-semibold">Sales Inquiries:</span> sales@cardoctor.com</li>
                        <li className="list-disc"><span className="font-semibold">Support:</span> support@cardoctor.com</li>
                    </ul>
